  ...
  <div class="card-body">
    <div class="row">
      <div class="col d-flex justify-content-end">
        ...
        data-bs-target="#ModalTambahUser"> Tambah Order</button>
      </div>
    </div>
  ...
  <div class="modal-dialog modal-lg modal-fullscreen-md-down">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Order Makanan dan Minumam</h1>
  ...
  <tbody>
    ...
    <tr class= "text-nowra">
      ...
      <td >
        ...
        href="./?x=orderitem&order=<?php echo $row['id_order']."&meja=". $row['meja'].
        ...
        <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm me-1 disabled" :
         "btn btn-warning btn-sm me-1" ; ?> "data-bs-toggle="modal" 
        data-bs-target="#ModalEdit<?php echo $row['id_order'] ?>"><i class="bi bi-pencil-square"></i></i></button>
        <button class=" <?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm me-1 disabled" :
         "btn btn-danger btn-sm me-1" ; ?>" data-bs-toggle="modal" 
